...
import org.polyfrost.oneconfig.loader.stage0.LaunchWrapperCapabilities;
...
public class DelayedStage0Tweaker implements ITweaker {
	...
	private final Stage1Loader stage1;
	...
	public DelayedStage0Tweaker() throws Exception {
		...
		(this.stage1 = new Stage1Loader(new LaunchWrapperCapabilities())).load();
